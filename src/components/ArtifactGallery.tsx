        ...
        >
          {artifacts.map((artifact, index) => (
            <div
              ...
              className={[
                'group cursor-pointer bg-white border border-black/10 rounded-lg overflow-hidden shadow-md shadow-black/5 hover:shadow-lg hover:border-black/15 transition-shadow duration-300',
            ...
            >
              <div className="flex flex-col h-full">
                ...
                <div className={compact ? 'p-3 flex flex-col flex-1 text-left' : 'p-4 md:p-5 flex flex-col flex-1 text-left'}>
                  ...
                  <p
                    className={`text-neutral-700 leading-relaxed line-clamp-none ${compact ? 'text-sm' : 'text-[0.95rem] md:text-base'}`}
                    style={{ fontFamily: serif }}
                  >
